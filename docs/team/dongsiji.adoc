...
The purpose of this document is to document the contribution that Dong SiJi have made in the project: *_Heart²_*
as a student undertaking the module under NUS School of Computing: CS2103T.
...
Below is a summary of the contributions that Dong SiJi have made to the project.

* *Major enhancement*: Enable filtering through the `list` command
** What it does:
** Justification:
** Highlights:
