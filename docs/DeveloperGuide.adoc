...
The above commands removes the 'client' in index 1 of the 'client' list and the 'service provider' in index 2 of the 'vendor' list respectively.
...
2.  System matches a Service Provider that it deemed the most suitable to the Client
+
Use case ends.
