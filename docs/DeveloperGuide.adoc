...
. Deleting a contact while all contacts of that type are listed

.. Prerequisites: List all contacts of that type using the `list` command. Multiple contacts of that type in the list.
