...
Welcome to *_Heart²_*! _Heart²_ is a desktop Wedding Planner application intended to make the job of Wedding Planning
companies simpler. It provides simple yet powerful features to match clients with their desired service providers
efficiently.
...
2.  System recognises the command
3.  System adds the new Client/Service Provider into the database
+
Use case ends.
...
[none]
* 2a. The new Client/Service Provider's syntax is not entered correct.
+
[none]
** 2a1. System shows a feedback to the user that the Client/Service Provider was not entered correctly.
+
Use case ends.
...
2.  System recognises the command
3.  System updates the existing Client/Service Provider according to the User's requests
+
Use case ends.
...
[none]
* 2a. The Client/Service Provider does not exist.
+
[none]
** 2a1. System shows a feedback to the user that the Client/Service Provider does not exist.
+
Use case ends.
...
2.  System recognises the command
3.  System deletes the Client/Service Provider specified
+
Use case ends.
...
[none]
* 1a. The system determines that the username is incorrect

+
[none]
** 1a1. The system display an error message
+
[none]
** 1a2. The system prompts the user to re-enter his username
+
[none]
** Use case resumes from step 1.

[none]
* 1b. The system determines that the password is incorrect
...
+
[none]
*** 1b2.1 The system determines that the password is incorrect
+
[none]
*** 1b2.2 The system provides the option for user to retrieve his forgotten password.
+
[none]
...
2.  System recognises the list command
3.  System returns either a list with all the Clients' names and contact numbers, or all the Service Providers' names and contact numbers
+
Use case ends.
...
[none]
* 3a. There is no Client or no Service Provider available
+
[none]
** 3a1. System recognises that there is no Client or Service Provider’s data

+
[none]
** 3a2. System returns a message to feedback to User that no Client or no Service Provider exist
...
2.  The System recognises the command
3.  The System displays the info related to the party back to the user
+
Use case ends.
...
+
[none]
** 1a1. System does not recognise the client or service provider
+
[none]
** 1a2. System prompts the User that such a Client or Service Provider does not exist
+
Use case ends.
...
2.  System recognises the match command
...
[none]
+
* 3a. There is no Service Provider available that matches the Client's need
+
[none]
** 3a1. System feedback to the User that no Service Provider is available for the current Client's need
+
Use case ends.
...
2.  System recognises the letter(s) typed
3.  System suggests a list of commands that starts with the letter(s) that the User has typed
+
Use case ends.
...
[none]
* 3a. There is no command that starts with the letter(s) that the User has typed
+
[none]
** 3a1. System does not suggest anything to the User
+
Use case ends.
