...
Callouts are a rectangular box with icon and words to point out various types of information. Below are the 3 callouts that will be used consistently throughout this document:
...
|This represents a *tip*. A tip is information that is often handy, and good for you to know. Tip is often not crucial, and you can choose to skip them.
|=====

[cols="^,<5a", frame=none]
|=====
|image:icon-danger.png[width="48", role="center"]
|This represents a *warning*. A warning is information that is extremely important. You should be cautious and read the warning statement carefully.
|=====
...
You can add attributes of the services your clients require or what vendors can provide by using the
