...
|This represents a *warning*. A warning denotes information of crucial importance, and you should be extremely cautious when reading the statement.
|=====
...
|=====
|image:icon-notes.png[width="48", role="center"]
|Only `help`, `login`, and `exit` commands are available prior to logging in. The rest of the commands are only available after logging into the application.
|=====
...
|=====
|image:icon-notes.png[width="48", role="center"]
|You cannot add a contact that already exists in the application. Two contacts are considered equal if they are of the same type (either both clients or both vendors), possess the same name and either the same phone number or the same email address.
|=====
...
|=====
|image:icon-tips.png[width="48", role="center"]
|You can `undo` adding of a contact!
|=====
...
|=====
|image:icon-tips.png[width="48", role="center"]
|You can `undo` deleting a contact!
|=====
...
|=====
|image:icon-notes.png[width="48", role="center"]
|You cannot update a contact to make the contact equalivalent to another contact that already exists in the application. Two contacts are considered equal if they are the same type (either both clients or both vendors), possess the same name, and either the same phone number or the same email address.
|=====
...
|=====
|image:icon-tips.png[width="48", role="center"]
|You can `undo` updating a contact!
|=====
...
|=====
|image:icon-danger.png[width="48", role="center"]
|Every service can only be added *once*. You can undo this command but cannot update it in the future.
|=====
