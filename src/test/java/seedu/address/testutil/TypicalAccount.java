...
public class TypicalAccount {
    ...
    public static final Account READ_ONLY_USER_ACCOUNT = new Account("readonlyuser", "@myPassword",
            Role.READ_ONLY_USER);
    public static final Account ROOTACCOUNT = new Account("rootUser", "rootPassword", Role.SUPER_USER);
    public static final Account EMPTY_USERNAME_ACCOUNT = new Account("", "rootPassword", Role.SUPER_USER);
