...
public class UpdateCommandParserTest {
    ...
    private static final String MESSAGE_INVALID_FORMAT_CLIENT =
            String.format(MESSAGE_INVALID_COMMAND_FORMAT, String.format(UpdateCommand.MESSAGE_USAGE,
    ...
    public void parse_allFieldsSpecified_success() {
        ...
        UpdateCommand expectedCommand = new UpdateCommand(targetIndex, descriptor, ContactType.CLIENT);
    ...
    public void parse_oneFieldSpecified_success() {
        ...
        UpdateCommand.EditContactDescriptor descriptor = new EditContactDescriptorBuilder()
        ...
        expectedCommand = new UpdateCommand(targetIndex, descriptor, ContactType.CLIENT);
        assertParseSuccess(parser, userInput, expectedCommand);
    ...
    public void parse_multipleRepeatedFields_acceptsLast() {
        ...
        UpdateCommand.EditContactDescriptor descriptor = new EditContactDescriptorBuilder().withPhone(VALID_PHONE_BOB)
