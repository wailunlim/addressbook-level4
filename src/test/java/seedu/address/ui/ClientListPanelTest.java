...
import static seedu.address.testutil.typicalContacts.getTypicalClients;
...
public class ClientListPanelTest extends GuiUnitTest {
     ...
     */
    private ObservableList<Contact> createBackingList(int personCount) throws Exception {
        Path xmlFile = createXmlFileWithPersons(personCount);
        XmlSerializableAddressBook xmlAddressBook =
                XmlUtil.getDataFromFile(xmlFile, XmlSerializableAddressBook.class);
        return FXCollections.observableArrayList(xmlAddressBook.toModelType().getContactList());
    }
    ...
    private Path createXmlFileWithPersons(int personCount) throws Exception {
        ...
        for (int i = 0; i < personCount; i++) {
            ...
            builder.append("<type>CLIENT</type>\n");
            builder.append("</persons>\n");
        }
        builder.append("</addressbook>\n");
